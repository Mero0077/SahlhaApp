...
namespace SahlhaApp.DataAccess.Migrations
{
    ...
    [Migration("20250601185458_addProviderRole")]
    partial class addProviderRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SahlhaApp.Models.Models.ContactUsMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SahlhaApp.Models.Models.ScheduledTask", b =>
                {
                    b.HasOne("SahlhaApp.Models.Models.Job", null)
                        .WithOne()
                        .HasForeignKey("SahlhaApp.Models.Models.ScheduledTask", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
