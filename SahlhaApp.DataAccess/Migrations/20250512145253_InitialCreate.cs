        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nofications_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PendingProviderVerifications",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingProviderVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PendingProviderVerifications_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rates_AspNetUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderSubServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProviderSubServices_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProviderSubServices_SubServices_SubServiceId",
                        column: x => x.SubServiceId,
                        principalTable: "SubServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskBids_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskBids_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Disputes_TaskAssignments_TaskAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_TaskAssignments_TaskAssignmentId",
                        column: x => x.TaskAssignmentId,
                        principalTable: "TaskAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Disputes_TaskAssignmentId",
                table: "Disputes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Nofications_ApplicationUserId",
                table: "Nofications",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_TaskAssignmentId",
                table: "Payments",
                column: "TaskAssignmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PendingProviderVerifications_ApplicationUserId",
                table: "PendingProviderVerifications",
                column: "ApplicationUserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderSubServices_ProviderId",
                table: "ProviderSubServices",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderSubServices_SubServiceId",
                table: "ProviderSubServices",
                column: "SubServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rates_ApplicationUserId1",
                table: "Rates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_JobId",
                table: "TaskAssignments",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_ProviderId",
                table: "TaskAssignments",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskBids_JobId",
                table: "TaskBids",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskBids_ProviderId",
                table: "TaskBids",
                column: "ProviderId");
        }
